const cardComponent = {
  ...
  socialLinks: {
    twitterLink: "https://twitter.com/izufab",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const html = `
  <figure>
      <img src="${cardComponent.ImageURL}"
    ...
    <span data-testid="emailAddress">email address: ${
      cardComponent.emailAddress
    }</span>
    <div class="socialLinks">
      <a target="_blank" href="${
        cardComponent.socialLinks.twitterLink
      }" data-testid="twitterLink"><svg xmlns="http://www.w3.org/2000/svg"
      ...
      <a target="_blank" href="${
        cardComponent.socialLinks.githubLink
      }" data-testid="githubLink"><svg xmlns="http://www.w3.org/2000/svg"
      ...
      <a target="_blank" href="${
        cardComponent.socialLinks.linkedin
